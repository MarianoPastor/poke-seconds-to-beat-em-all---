...
class Level2(WindowScreen):
    def __init__(self,sprite_groups,music_path, volume_float, background_path) -> None: 
        ...
        self.npc_1_2 = NPC(sprite_groups=[self.all_sprites,self.enemy_groups],image_surface= NPC.sticker_dictionary(self,SNORLAX_SPRITES,"left",3),life= LIFE_ENEMY,speed= SPEED_ENEMY,sound_attack= SHOOT_SOUND,sound_damage= DAMAGE_SOUND,sound_life_gain= LIFE_SOUND,size= SIZE_ENEMY,center_y=HEIGHT/2.1,center_x=50,movement=False,power_jump=JUMP_PLAYER)
        self.npc_1_3 = NPC(sprite_groups=[self.all_sprites,self.enemy_groups],image_surface= NPC.sticker_dictionary(self,BEEDRIL_SPRITES,"left",3),life= LIFE_ENEMY,speed= SPEED_ENEMY,sound_attack= SHOOT_SOUND,sound_damage= DAMAGE_SOUND,sound_life_gain= LIFE_SOUND,size= SIZE_ENEMY,center_y=HEIGHT/3,center_x=WIDTH-50,movement=True,power_jump=JUMP_PLAYER)
        self.npc_1_4 = NPC(sprite_groups=[self.all_sprites,self.enemy_groups],image_surface= NPC.sticker_dictionary(self,MOLTRES_SPRITES,"left",3),life= LIFE_ENEMY,speed= SPEED_ENEMY,sound_attack= SHOOT_SOUND,sound_damage= DAMAGE_SOUND,sound_life_gain= LIFE_SOUND,size= SIZE_ENEMY,center_y=85,center_x=WIDTH/2,movement=False,power_jump=JUMP_PLAYER)
        self.platform_1 = Platform([self.all_sprites,self.platforms_group],(WIDTH/2,HEIGHT/1.5,200,20),BLACK)
        self.platform_2 = Platform([self.all_sprites,self.platforms_group],(WIDTH/3,HEIGHT/1.8,150,20),GREEN)
        self.platform_3 = Platform([self.all_sprites,self.platforms_group],(75,HEIGHT/1.8,150,20),GREEN)
        self.platform_4 = Platform([self.all_sprites,self.platforms_group],(WIDTH/1.5,HEIGHT/2.2,150,20),BLUE)
        self.platform_4 = Platform([self.all_sprites,self.platforms_group],(WIDTH-75,HEIGHT/2.3,150,20),BLUE)
    ...
    def level_logic(self):
        if len(self.enemy_groups) == 0:
            self.playing = False
            self.time_save()
            self.screen_level = Level3(sprite_groups=[self.all_sprites],music_path=LEVEL_SOUND,volume_float=VOLUME,background_path=LEVEL_3)
