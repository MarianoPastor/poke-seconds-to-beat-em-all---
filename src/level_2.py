...
class Level2(LevelsWindows):
    def __init__(self,sprite_groups,music_path, volume_float, background_path,screen) -> None: 
        ...
        self.platform_3 = Platform([self.all_sprites_group,self.platforms_group],image_surface=PLATFORM_LOADED,size=(85,15),center_x=65,center_y=HEIGHT/1.8)
    ...
    def level_logic(self):
        if len(self.enemy_groups) == 0:
            ...
            self.data_player[0]["total_time"] = self.data_player[0]["total_time"] + self.time_2
